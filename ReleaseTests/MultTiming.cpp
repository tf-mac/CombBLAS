...
{
   public:
    typedef SpDCCols<int32_t, NT> DCCols;
    typedef SpParMat<int32_t, NT, DCCols> MPI_DCCols;
};
...
int main(int argc, char *argv[])
{
    ...
    if (1) {
        ...
        SpTuples<int32_t, float> tmptuples(10, 10, 10);
        SpDCCols<int32_t, float> tmpSpdcsc;
        Dcsc<int32_t, float> tmpdcsc;
        SpParMat<int32_t, float, SpDCCols<int32_t, float>> spmat;
        ...
        // 	PSpMat<ElementType>::MPI_DCCols C = Mult_AnXBn_DoubleBuff<PTDOUBLEDOUBLE, ElementType, PSpMat<
        // 		ElementType>::DCCols>(A, B);
        ...
        // } {
        // 	// force the calling of C's destructor
        // 	PSpMat<ElementType>::MPI_DCCols C = Mult_AnXBn_Synch<PTDOUBLEDOUBLE, ElementType, PSpMat<
        // 		ElementType>::DCCols>(A, B);
        // 	C.PrintInfo();
        // }
